...
export declare class SubMemberService {
    ...
    constructor(httpService: HttpService, jsonServerService: JsonServerService, transactionService: TransactionsService);
    ...
    editAllowance(id: string, allowance: number): Promise<{
        success: boolean;
        message: string;
        data: {
            finance: any;
